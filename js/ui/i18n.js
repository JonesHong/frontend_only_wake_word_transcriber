    ...
    loadTranslations() {
        this.translations = {
            'zh-TW': {
                ...
                // 模式切換
                'ui.streamingMode': '即時語音',
                'ui.batchMode': '檔案/錄音',
                'ui.fileUpload': '檔案上傳 / 錄音轉譯',
                'ui.dropFiles': '拖放音訊檔案至此處',
                'ui.supportedFormats': '支援 MP3, WAV, M4A, WEBM',
                'ui.startRecording': '開始錄音',
                'ui.stopRecording': '停止錄音',
                'ui.transcriptionEngine': '轉譯引擎',
                'ui.autoSelect': '自動選擇',
                'ui.webSpeech': 'Web Speech API',
                'ui.whisper': 'Whisper (本地)',
                'ui.outputMode': '輸出模式',
                'ui.streamingOutput': '即時輸出',
                'ui.completeOutput': '完整輸出',
                'ui.modelSource': '模型來源',
                'ui.localModel': '本地模型',
                'ui.remoteModel': '遠端模型',
                'ui.localModelHint': '本地模型速度更快，無需網路連線',
                'ui.remoteModelHint': '遠端模型從 Hugging Face 載入，需要網路連線',
                'ui.noFiles': '尚無檔案',
                'ui.recordingWaveform': '錄音波形',
                'ui.batchResults': '批次轉譯結果',
                'ui.downloadAllText': '下載所有文字',
                'ui.downloadRecording': '下載錄音',
                'ui.playAudio': '播放',
                'ui.pauseAudio': '暫停',
                'ui.copyText': '複製文字',
                'ui.copied': '已複製!',
            ...
            'en': {
                ...
                // Mode switching
                'ui.streamingMode': 'Live Speech',
                'ui.batchMode': 'File/Recording',
                'ui.fileUpload': 'File Upload / Recording Transcription',
                'ui.dropFiles': 'Drop audio files here',
                'ui.supportedFormats': 'Supports MP3, WAV, M4A, WEBM',
                'ui.startRecording': 'Start Recording',
                'ui.stopRecording': 'Stop Recording',
                'ui.transcriptionEngine': 'Transcription Engine',
                'ui.autoSelect': 'Auto Select',
                'ui.webSpeech': 'Web Speech API',
                'ui.whisper': 'Whisper (Local)',
                'ui.outputMode': 'Output Mode',
                'ui.streamingOutput': 'Streaming',
                'ui.completeOutput': 'Complete',
                'ui.modelSource': 'Model Source',
                'ui.localModel': 'Local Model',
                'ui.remoteModel': 'Remote Model',
                'ui.localModelHint': 'Local models are faster and work offline',
                'ui.remoteModelHint': 'Remote models load from Hugging Face and require internet',
                'ui.noFiles': 'No files yet',
                'ui.recordingWaveform': 'Recording Waveform',
                'ui.batchResults': 'Batch Transcription Results',
                'ui.downloadAllText': 'Download All Text',
                'ui.downloadRecording': 'Download Recording',
                'ui.playAudio': 'Play',
                'ui.pauseAudio': 'Pause',
            ...
            'ja': {
                ...
                // モード切り替え
                'ui.streamingMode': 'リアルタイム音声',
                'ui.batchMode': 'ファイル/録音',
                'ui.fileUpload': 'ファイルアップロード / 録音転写',
                'ui.dropFiles': '音声ファイルをここにドロップ',
                'ui.supportedFormats': 'MP3, WAV, M4A, WEBMに対応',
                'ui.startRecording': '録音開始',
                'ui.stopRecording': '録音停止',
                'ui.transcriptionEngine': '転写エンジン',
                'ui.autoSelect': '自動選択',
                'ui.webSpeech': 'Web Speech API',
                'ui.whisper': 'Whisper (ローカル)',
                'ui.outputMode': '出力モード',
                'ui.streamingOutput': 'ストリーミング',
                'ui.completeOutput': '完全出力',
                'ui.modelSource': 'モデルソース',
                'ui.localModel': 'ローカルモデル',
                'ui.remoteModel': 'リモートモデル',
                'ui.localModelHint': 'ローカルモデルは高速でオフライン動作可能',
                'ui.remoteModelHint': 'リモートモデルはHugging Faceから読み込み、インターネット接続が必要',
                'ui.noFiles': 'ファイルなし',
            }
        };
    }
